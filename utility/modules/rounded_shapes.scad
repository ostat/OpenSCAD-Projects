...
if(rounded_shapes_demo && $preview){
  ...
  roundedDisk(r=20, roundedr=4, half=0);
  
  translate([0,50,0])
    roundedDisk(r=20, roundedr=4, half=1);
  
  translate([0,100,0])
    roundedDisk(r=20, roundedr=4, angle=90);
  
  
  translate([50,0,0])
    roundedCylinder(h = 50,r=20,roundedr=5);

  translate([50,50,0])
    roundedCylinder(h = 50,r=20,roundedr=5, angle=180);
